...
<html lang="zxx" class="no-js">
  <head>
    <meta charset="utf-8" />
    <title>Perdect Web Design &amp; Mobile App Development Company India</title>
    <meta name="description" content="Perdect is Worldwide, based Web, App, Development Company">
    <meta name="keywords" content="Web Design, App Design, Digital Marketing, Creative Agency, Marketing Agency">
    ...
    <header class="ree-header fixed-top">
      <div class="container-fluid m-p-l-r-0">
        <div class="menu-header">
          <div class="menu-logo">
            <div class="dskt-logo"><a class="nav-brand" href="./">	<img src="images/logo.svg" alt="Logo" class="ree-logo" /> </a> </div>
          </div>
          <div class="ree-nav" role="navigation">
            <ul class="nav-list">
              <li class="megamenu">
                <a href="index.html" class="menu-links">About Us</a>
              </li>
              <li class="megamenu">
                <a href="services.html" class="menu-links">Our Services</a>
              </li>
              <li class="megamenu mega-small">
                <a href="portfolio-modern.html"  class="menu-links">Case Studies</a>
              </li>
              <li class="megamenu mega-small">
                <a href="blog.html"  class="menu-links">Blog</a>
              </li>
              <li class="megamenu mega-small">
          ...
          <div class="ree-nav-cta">
            <ul>
              <li><a href="get-quote.html" class="ree-btn ree-btn0 ree-btn-grdt2"> Start Project</a> </li>
            </ul>
          </div>
          ...
          <nav id="main-nav">
            <ul>
              ...
              <li><a href="portfolio-modern.html">Case Studies</a>
              </li>
            ...
            <ul class="bottom-nav">
              <li class="ree-hc">
                <a href="tel:123567890" rel="noreferrer" target="_blank">
                  <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2016/xlink" x="0px" y="0px" viewBox="0 0 25.625 25.625" style="enable-background:new 0 0 25.625 25.625;" xml:space="preserve">
                    <g>
              ...
              <li class="ree-hc">
                <a href="skype:Perdect.company" rel="noreferrer" target="_blank">
              ...
              <li class="ree-hc">
                <a href="wa.me/+91123456789" rel="noreferrer" target="_blank">
                  <svg version="1.1"  xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/2016/xlink" x="0px" y="0px" viewBox="0 0 512 512"	style="enable-background:new 0 0 512 512;" xml:space="preserve">
                    <g>
          ...
          <div class="footer-rowset">
            <div class="col footer-head">
              ...
              <ul class="footer-links-list social-linkz">
                <li><a href="tel:+911234567890"><span><i class="fas fa-phone-square-alt"></i></span> +91 7727897676 </a></li>
                <li><a href="tel:+911234567890"><span><i class="fab fa-whatsapp-square"></i></span> +91 7727897676</a></li>
                <li><a href="mailto:career@Perdect.com"><span><i class="fas fa-envelope"></i></span> career@perdect.com</a></li>
                <li><a href="mailto:career@Perdect.com"><span><i class="fas fa-envelope"></i></span> info@perdect.com</a></li>
                <li><a href="skype:Perdect.company"><span><i class="fab fa-skype"></i></span> perdect-skype</a></li>
              </ul>
            </div>
            <div class="col footer-head">
              <h5>Follow Us</h5>
              <ul class="footer-links-list social-linkz">
                <li><a href="https://www.facebook.com/perdect/"><span><i class="fab fa-facebook-f"></i></span> Facebook</a>	</li>
                <li><a href="https://www.instagram.com/iperdect/"><span><i class="fab fa-instagram"></i></span> Instagram</a> </li>
                <li><a href="https://www.linkedin.com/company/perdect/"><span><i class="fab fa-linkedin-in"></i></span> linkedin</a></li>
              ...
              <div class="col-lg-3 vcenter">
                <div class="footer-ree-lg">
                  <div class="footer-logo">
                    <a href="#"> <img src="{{asset('web_assest/images/footer-logo.svg')}}" alt="reeven" class="img"> </a>
                  </div>
                  ...
                  <h6 class="mt10">Overall client rating is 4.9 out of 8,500 Clients for Perdect</h6>
                </div>
              </div>
              <div class="col-lg-6 vcenter">
                <div class="ref-logo">
                  <a href="#"> <img src="{{asset('web_assest/images/brand-logo/app-futura.svg')}}" alt="Logo"> </a>
                  <a href="#"> <img src="{{asset('web_assest/images/brand-logo/clutch.svg')}}" alt="Logo"> </a>
                  <a href="#"> <img src="{{asset('web_assest/images/brand-logo/goodfirm.svg')}}" alt="Logo"> </a>
                  <a href="#"> <img src="{{asset('web_assest/images/brand-logo/itfirm.svg')}}" alt="Logo"> </a>
                </div>
              </div>
          ...
          <div class="row">
            ...
            <div class="col-lg-7">
              <div class="ft-copyright ft-r">
                <p>Copyright © 2021 Perdect Pvt Ltd. All rights reserved.</p>
              </div>
            </div>
          </div>
        </div>
